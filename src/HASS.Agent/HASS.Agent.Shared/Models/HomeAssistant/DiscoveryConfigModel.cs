...
/// <summary>
/// Configuration model of all discoverable objects
/// </summary>
...
public abstract class DiscoveryConfigModel
{
    ...
    /// </summary>
    /// <value></value>
    public string State_topic { get; set; } = null!;
}
...
public class SensorDiscoveryConfigModel : DiscoveryConfigModel
{
    ...
    public string Object_id
    {
        get
        {
            ...
            return EntityName?.Contains(Device?.Name ?? string.Empty) == true 
                ? EntityName 
                : $"{Device?.Name}_{EntityName}";
        }
        set => _objectId = value;
    }
