...
/// <summary>
/// Multivalued sensor containing Windows Update info
/// </summary>
public class WindowsUpdatesSensors : AbstractMultiValueSensor
{
    ...
    public sealed override void UpdateSensorValues()
    {
        ...
        var driverUpdateCountSensor = new DataTypeIntSensor(
            _updateInterval, 
            driverUpdateCountEntityName, 
        ...
        var softwareUpdateCountSensor = new DataTypeIntSensor(
            _updateInterval, 
            softwareUpdateCountEntityName, 
            "Software Updates Pending", 
            softwareUpdateCountId, 
            string.Empty, 
            "measurement", 
            "mdi:microsoft-windows", 
            string.Empty, 
        ...
        var driverUpdatesSensor = new DataTypeIntSensor(
            _updateInterval, 
            driverUpdatesEntityName, 
        ...
        var softwareUpdatesSensor = new DataTypeIntSensor(
            _updateInterval,
            softwareUpdatesEntityName, 
